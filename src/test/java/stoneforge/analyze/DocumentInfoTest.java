...
public class DocumentInfoTest extends JavadocTestSupport {
    ...
    public void linkTagInternalType() {
        ExecutableInfo info = currentMethod();
        assert sameXML(info.comment, "<span class='A'><a href='/types/stoneforge.analyze.DocumentInfoTest.html'>DocumentInfoTest</a></span>");
    }
    ...
    public void linkTagInternalMethod() {
        ExecutableInfo info = currentMethod();
        assert sameXML(info.comment, "<span class='A'><a href='/types/stoneforge.analyze.DocumentInfoTest.html#linkTagInternalMethod()'>#linkTagInternalMethod()</a></span>");
    }
    ...
    public void linkTagInternalTypeAndMethod() {
        ExecutableInfo info = currentMethod();
        assert sameXML(info.comment, "<span class='A'><a href='/types/stoneforge.analyze.DocumentInfoTest.html#linkTagInternalTypeAndMethod()'>DocumentInfoTest#linkTagInternalTypeAndMethod()</a></span>");
    }
    ...
    public void linkplainTagInternalMethod() {
        ExecutableInfo info = currentMethod();
        assert sameXML(info.comment, "<span class='A'><a href='/types/stoneforge.analyze.DocumentInfoTest.html#linkplainTagInternalMethod()'>#linkplainTagInternalMethod()</a></span>");
    }
    ...
    public void linkplainTagInternalTypeAndMethod() {
        ExecutableInfo info = currentMethod();
        assert sameXML(info.comment, "<span class='A'><a href='/types/stoneforge.analyze.DocumentInfoTest.html#linkplainTagInternalTypeAndMethod()'>DocumentInfoTest#linkplainTagInternalTypeAndMethod()</a></span>");
    }
